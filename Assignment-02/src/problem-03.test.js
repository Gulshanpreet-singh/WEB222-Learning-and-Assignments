  ...
  describe('transformObservations() function', function () {
    ...
    test('real-world data should behave the same way as test data', function () {
      expect(transformObservations(data)).toEqual([
        {
          geoCoords: [-79.3565522733, 43.798774894],
          id: 67868131,
          isResearchQuality: true,
          photoUrls: ['https://static.inaturalist.org/photos/109762131/square.jpg?1610308133'],
          photosCount: 1,
          speciesGuess: 'Muskrat',
          user: '@dridgen'
        },
        {
          geoCoords: [-79.3520872, 43.7948387],
          id: 66528178,
          isResearchQuality: false,
          photoUrls: ['https://static.inaturalist.org/photos/107267018/square.jpeg?1607882195'],
          photosCount: 1,
          speciesGuess: 'Cordia sebestena sebestena',
          user: '@mohammedmaster'
        },
        {
          geoCoords: [-79.3604902234, 43.798397314],
          id: 61770700,
          isResearchQuality: true,
          photoUrls: ['https://static.inaturalist.org/photos/98884441/square.jpg?1601901356'],
          photosCount: 1,
          speciesGuess: 'Common Eastern Bumble Bee',
          user: '@johnnyrehabb'
        },
        {
          geoCoords: [-79.35387869, 43.79949591],
          id: 61472666,
          isResearchQuality: false,
          photoUrls: ['https://static.inaturalist.org/photos/98374594/square.jpeg?1601643792'],
          photosCount: 1,
          speciesGuess: "Angel's Trumpet",
          user: '@monicayeung'
        },
        {
          geoCoords: [-79.3423842408, 43.7937155457],
          id: 61307088,
          isResearchQuality: false,
          photoUrls: [
        ...
        {
          geoCoords: [-79.3530766, 43.79977493],
          id: 60706122,
          isResearchQuality: true,
          photoUrls: ['https://static.inaturalist.org/photos/97090180/square.jpeg?1601038974'],
          photosCount: 1,
          speciesGuess: 'American trumpet vine',
          user: '@monicayeung'
        },
        {
          geoCoords: [-79.3398328018, 43.7932344873],
          id: 60671346,
          isResearchQuality: true,
          photoUrls: ['https://static.inaturalist.org/photos/97031452/square.jpeg?1600996784'],
          photosCount: 1,
          speciesGuess: 'bittersweet nightshade',
          user: '@kareberry'
        },
        {
          geoCoords: [-79.338568, 43.792673],
          id: 60021049,
          isResearchQuality: false,
          photoUrls: [
        ...
        {
          geoCoords: [-79.33852796, 43.79248394],
          id: 60020978,
          isResearchQuality: false,
          photoUrls: ['https://static.inaturalist.org/photos/95944070/square.jpeg?1600471140'],
          photosCount: 1,
          speciesGuess: '矮牽牛屬',
          user: '@xinjielin'
        },
        {
          geoCoords: [-79.33821043, 43.79259349],
          id: 60004808,
          isResearchQuality: false,
          photoUrls: [
